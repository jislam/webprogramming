    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
      <tr>
        ...
        <td class="content">
			...
			<?php 
				echo $_POST['optPayment'] == 'paypal' ? 'Paypal' : 'Cash on Delivery'; 
				if($_POST['optPayment'] == 'paypal'){
					echo 'Paypal';}
				...
				<tr>
					<td>Card Number</td>
					<td><input name="txtCardNumber" type="text" class="box" id="txtCardNumber" size="20" maxlength="100" required = true></td>					
				</tr>	
                <tr>
                    <td></td>
                    <td><p id="error" style="display:none;color:red"></p></td>                  
                </tr>   
				<tr>
					<td>Expires</td>	
					<td></td>				
				...
				<tr>
					<td>Enter Month</td>
					<td><input name="txtCardExprireMonth" type="text" class="box" id="txtCardExprireMonth" size="10" maxlength="100" required = true>
					</td>				
				</tr>
				<tr>
					<td>Enter Year</td>
					<td><input name="txtCardExpireYear" type="text" class="box" id="txtCardExpireYear" size="10" maxlength="100" required = true> 	
						</td>
				</tr>
				<tr></tr>
				<tr>
					<td>Security Code</td>
					<td><input name="txtSecurityCode" type="text" class="box" id="txtSecurityCode" size="10" maxlength="100" required = true>						</td>
				</tr>
				<script>

                    window.onload = function() {
                        var par = document.getElementById("error");
                        document.getElementById("txtCardNumber").onblur = function fun() {
                            var number = document.getElementById('txtCardNumber').value

                            if(validateCardNumber(number) === false) {
                                par.style.display = "block";
                                par.innerHTML = 'Invalid Card Number';
                            } else {
