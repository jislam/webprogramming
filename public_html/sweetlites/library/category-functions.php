...
function fetchCategories()
{
    ...
    $sql = "SELECT cat_id, parent_id, cat_name, cat_image, cat_desc FROM tbl_category ORDER BY cat_id, parent_id ";
    ...
    $stmt->execute();
    $stmt->store_result();
    $stmt->bind_result($cat_id, $parent_id, $cat_name, $cat_image, $cat_desc);
