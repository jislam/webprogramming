...
function addCategory()
{
    ...
    $sql   = "INSERT INTO tbl_category (parent_id, cat_name, cat_desc, cat_image,cat_publish,create_date,modified_date)
              VALUES ($parentId, '$name', '$description', '$catImage','$publish', NOW(), NOW())";
...
function modifyCategory()
{
    ...
    $sql    = "UPDATE tbl_category
               SET cat_name = '$name', cat_desc = '$description', cat_image = $catImage,cat_publish='$publish'
               WHERE cat_id = $catId";
...
function deleteCategory()
{
	...
	$sql = "SELECT prod_id, prod_image, prod_thumbnail
	        FROM product
