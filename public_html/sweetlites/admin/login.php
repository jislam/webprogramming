  ...
  <tr>
    <th height="401" scope="row"><div align="center">
      <table width="603" height="236" border="1">
          <tr>
            <td width="593" height="25"><h1 class="style4 style5"><span class="style7">SweetLite</span> <span class="style7">Administration Login</span> </h1></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="124"><div align="center">
                <table width="590" border="0">
                  <tr>
                    <td width="230"><div align="left" class="style2 style5">Use a valid username and password to gain access to the Administrator Back-end. </div></td>
                    <td width="10">&nbsp;</td>
